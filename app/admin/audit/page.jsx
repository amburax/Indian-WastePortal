    ...
    <div className="min-h-screen bg-mesh-light">
      <header className="sticky top-0 z-10 bg-[#eef2f0]/85 backdrop-blur border-b border-[#dde5e1]">
        <div className="px-6 md:px-8 py-4">
          <h1 className="font-display text-[20px] font-bold text-[#0e3b2e] leading-tight">Audit Trail</h1>
          <p className="text-[12.5px] text-slate-500">{data?.rows?.length ?? 0} entries</p>
        </div>
      </header>
