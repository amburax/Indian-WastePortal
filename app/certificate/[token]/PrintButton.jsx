...
export default function PrintButton({ token }) {
  return (
    <>
      ...
      <div className="absolute top-6 right-6 print:hidden flex items-center gap-2">
        {token && (
          <a
            href={`/api/certificate/${token}/pdf`}
            className="bg-emerald-700 text-white hover:bg-emerald-800 shadow-lg px-5 py-2.5 rounded-full font-bold text-sm flex items-center gap-2 transition-transform hover:scale-105"
          >
